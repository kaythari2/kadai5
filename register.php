...
if (isset($_GET['id'])) {
    $status = "編集";
    $from = "edit";
    $editData = $controller->getTCarBaseWithId($_GET['id']);
}
var_dump($mCommons[7]);
?>
<!DOCTYPE html>
            ...
            <form id="submit_form" name="submit_form" action="confirm.php" method="post">
                <div class="inner">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="st_cd">
                                            ...
                                            ?>
                                                <option value="<?php echo $key; ?>" <?php if (isset($_GET['id']) && $editData["st_cd"] == $key) {  echo "selected"; }  ?>>
                                                    <?php echo $value; ?>
                                                </option>
                                            <?php
                                            }
                    ...
                    <input type="submit" id="car_submit_btn" class="btnRed wL" value="<?php echo $status; ?>">
                        <!-- <button type="submit" id="car_submit_btn" class="btnRed wL">登録</button> -->
                    </div>
                </div><!-- End of.inner -->
            </form>
        </div><!-- End of#contents -->
